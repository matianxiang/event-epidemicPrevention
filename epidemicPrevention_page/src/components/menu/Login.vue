      ...
      login(){
          if (!this.input_user || !this.input_pwd){
            ...
            this.$Axios({
                ...
                success:(result)=>{
                    // 登录失败 后端返回错误信息 用户名或密码输入错误
                 if (result=="用户名或密码输入错误！"){
                     ...
                     if (this.radio3==1)  window.location.href=' http://localhost:4500/#/admin/home'
                     if (this.radio3==2)  window.location.href=' http://localhost:4500/#/student/home'
                     if (this.radio3==3)  window.location.href=' http://localhost:4500/#/teacher/home'
                 }
                }
            })
